...
public class Compatable {
	...
	public static void main(String[] args) {
			...
			System.out.println("---- Sorting name by comparator instance passing directly to sort method ----");
			...
			for(Items item : list)  System.out.println(item);  
			System.out.println("----salary asc--");
			//Comparator<Items> sortByPrice = new Comparator<Items>(){
			//public double.compare(Items i1,Items i2){
			//		return i1.getPrice() - i2.getPrice();}};
			
			//Collections.sort(list, sortBySalary);for(Items item : list)  System.out.println(item);
		}
